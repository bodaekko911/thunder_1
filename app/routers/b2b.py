...
<div class="header-top">
    <table class="inv-meta">
        <tr><td class="label">Invoice No:</td><td><b>{inv.invoice_number}</b></td></tr>
        <tr><td class="label">Date:</td><td>{inv.created_at.strftime('%d-%b-%y') if inv.created_at else '—'}</td></tr>
        <tr><td class="label">Status:</td><td>
            <b>{inv.status.upper()}</b>
            {'<span class="status-stamp paid">PAID</span>' if inv.status == "paid" else '<span class="status-stamp">UNPAID</span>' if inv.status == "unpaid" else ''}
        </td></tr>
    </table>
...
<table class="customer-block">
    <tr>
        ...
        <td width="40"></td>
        <td class="label" style="color:#555">Type:</td>
        <td><b>{inv.invoice_type.replace("_"," ").title()}</b></td>
    </tr>
    <tr>
        <td class="label" style="color:#555">Customer Name:</td>
        <td><b>{client_name}</b></td>
        <td></td>
        <td class="label" style="color:#555">Payment:</td>
...
<nav>
    ...
    <a href="/b2b/"       class="nav-link active">B2B</a>
