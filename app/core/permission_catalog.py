...
PERMISSION_MATRIX = [
    ...
    },
    {
        ...
        "actions": [
            ...
            {"action": "create_delivery", "key": "action_farm_delivery_create", "label": "Record delivery"},
            {"action": "update_delivery", "key": "action_farm_delivery_update", "label": "Edit delivery"},
            {"action": "delete_delivery", "key": "action_farm_delivery_delete", "label": "Delete delivery"},
            {"action": "log_weather", "key": "action_farm_weather_log", "label": "Log weather"},
        ],
    },
    {
        "module": "hr",
